...
class Ui_frm_vehicle_document(object):
    def setupUi(self, frm_vehicle_document):
        ...
        self.lbl_type_vehicle_dodument = QtWidgets.QLabel(parent=frm_vehicle_document)
        self.lbl_type_vehicle_dodument.setObjectName("lbl_type_vehicle_dodument")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.lbl_type_vehicle_dodument)
        self.cbx_type_vehicle_document = QtWidgets.QComboBox(parent=frm_vehicle_document)
        self.cbx_type_vehicle_document.setObjectName("cbx_type_vehicle_document")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cbx_type_vehicle_document)
        self.lbl_name = QtWidgets.QLabel(parent=frm_vehicle_document)
        self.lbl_name.setObjectName("lbl_name")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.lbl_name)
        self.txt_name = QtWidgets.QLineEdit(parent=frm_vehicle_document)
        self.txt_name.setObjectName("txt_name")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.txt_name)
...
"background: rgb(191, 228, 241)")
        ...
        frm_vehicle_document.setTabOrder(self.cbx_type_vehicle_document, self.txt_name)
    ...
    def retranslateUi(self, frm_vehicle_document):
        ...
        self.lbl_type_vehicle_dodument.setText(_translate("frm_vehicle_document", "Tipo de documento"))
