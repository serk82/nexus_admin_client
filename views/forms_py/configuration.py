...
class Ui_frm_configuration(object):
    def setupUi(self, frm_configuration):
        ...
        self.menu_Veh_culos = QtWidgets.QMenu(parent=self.menu_configuration)
        self.menu_Veh_culos.setObjectName("menu_Veh_culos")
        ...
        self.menu_Veh_culos.addAction(self.action_Tipos_de_documento)
        ...
        self.menu_configuration.addSeparator()
        self.menu_configuration.addAction(self.menu_Veh_culos.menuAction())
    ...
    def retranslateUi(self, frm_configuration):
        ...
        self.menu_Veh_culos.setTitle(_translate("frm_configuration", "&Vehículos"))
