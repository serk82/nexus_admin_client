...
class Ui_frm_notification_settings(object):
    def setupUi(self, frm_notification_settings):
        ...
        self.gridLayout.addWidget(self.chb_inspection_kms_expiry, 1, 0, 1, 1)
    ...
    def retranslateUi(self, frm_notification_settings):
        ...
        self.chb_itv_expiry.setText(_translate("frm_notification_settings", "Caducidades ITV"))
        self.lbl_itv_expiry.setText(_translate("frm_notification_settings", "días antes"))
        self.chb_inspection_kms_expiry.setText(_translate("frm_notification_settings", "Revisiones"))
